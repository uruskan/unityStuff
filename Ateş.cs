...
public class Ateş : MonoBehaviour {
    ...
    public void ates()
    {
        ...
        mermi.GetComponent<Rigidbody>().AddForce(-mermi.transform.right * mermihizi);
        var mermi2 = (GameObject)Instantiate(
            mermipf,
            n2.transform.position,
            n2.transform.rotation
            ) as GameObject;
        mermi2.GetComponent<Rigidbody>().AddForce(-mermi2.transform.right * mermihizi);
        var mermi3 = (GameObject)Instantiate(
            mermipf,
            n3.transform.position,
            n3.transform.rotation
            ) as GameObject;
        mermi3.GetComponent<Rigidbody>().AddForce(-mermi3.transform.right * mermihizi);
        var mermi4 = (GameObject)Instantiate(
            mermipf,
            n4.transform.position,
            n4.transform.rotation
            ) as GameObject;
        mermi4.GetComponent<Rigidbody>().AddForce(-mermi4.transform.right * mermihizi);
